    ...
    <table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
        <tr>
            ...
            <th class="col-md-1 text-center">
                <div align="right">DR</div>
            </th>
            <th class="col-md-1 text-center">
                <div align="right">CR</div>
            </th>
            <th class="col-md-1 text-center">
        ...
        <tr>
            ...
            <td class="text-danger text-end">
                <div align="right">{{ $sql[0]->Balance }}</div>
            </td>
        </tr>
        @foreach ($journal as $key => $value)
            <tr>
                ...
                <td class="text-center">
                    <div align="center">{{ $value->VHNO }}</div>
                </td>
                <td class="text-center">
                    <div align="center">{{ $value->JournalType }}</div>
                </td>
        ...
        <tr class="table-active">
            ...
            <td class="text-end fw-bolder">
                <div align="right">{{ number_format($DrTotal, 2) }}</div>
            </td>
            <td class="text-end fw-bolder">
                <div align="right">{{ number_format($CrTotal, 2) }}</div>
            </td>
