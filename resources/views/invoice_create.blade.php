                          ...
                          <tr class="p-3" style="vertical-align: top;">
                            ...
                            <td>
                              <input type="text" name="PaxName[]" id="PaxName_1" class=" form-control  "
                                autocomplete="off" placeholder="PaxName"><input type="text" name="TicketNo[]" id="TicketNo_1" class="form-control  " autocomplete="off" placeholder="Ticket No">
                            </td>
                           
                            <td>
                              <input type="text" name="Sector[]" id="Sector_1" class=" form-control  "
                                autocomplete="off" placeholder="Sector"><input type="text" name="PNR[]" id="PNR_1" class=" form-control  " autocomplete="off" placeholder="PNR">
                            </td>
                            <td>
                              <input type="number" name="Fare[]" id="Fare_1" class=" form-control changesNo" required
                                ...
                                <input type="text" name="Passport[]" id="Passport_1" class="form-control  " autocomplete="off" placeholder="Passport #">
                            </td>
                            <td>
                              <input type="number" name="Taxable[]" id="Taxable_1" class=" form-control  changesNo  "
                                autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;"
                                onpaste="return false;" step="0.01"  placeholder="VAT %">
                                <input type="number" name="TaxAmount[]" id="TaxAmount_1" class="form-control changesNo"
                                autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;"
                            ...
                            <td>
                              <input type="number" name="ItemTotal[]" id="total_1" required
                                ...
                                <input type="date" name="DepartureDate[]" id="DepartureDate_1" class="form-control">
                            </td>
                          </tr>
